...
<template>
  <form class="max-w-4xl mx-auto min-h-screen text-lg" autocomplete="off">
    <h2 class="text-2xl font-semibold text-gray-900 dark:text-white p-6 text-center">Informações de Contato</h2>
    ...
    <!-- Campos Endereço e CEP na mesma linha -->
    ...
    <div class="relative z-0 w-full mb-5 group">
      <input type="text" name="pai" id="pai"
             ...
             placeholder=" " required autocomplete="off" />
      <label for="pai"
             class="peer-focus:font-medium absolute text-lg text-gray-500 dark:text-gray-400 duration-300 transform -translate-y-6 scale-75 top-3 -z-10 origin-[0] peer-focus:start-0 rtl:peer-focus:translate-x-1/4 peer-focus:text-blue-600 peer-focus:dark:text-blue-500 peer-placeholder-shown:scale-100 peer-placeholder-shown:translate-y-0 peer-focus:scale-75 peer-focus:-translate-y-6">Pai</label>
    </div>
    ...
    <div class="relative z-0 w-full mb-5 group">
      <input type="text" name="mae" id="mae"
             ...
             placeholder=" " required autocomplete="off" />
      <label for="mae"
             class="peer-focus:font-medium absolute text-lg text-gray-500 dark:text-gray-400 duration-300 transform -translate-y-6 scale-75 top-3 -z-10 origin-[0] peer-focus:start-0 rtl:peer-focus:translate-x-1/4 peer-focus:text-blue-600 peer-focus:dark:text-blue-500 peer-placeholder-shown:scale-100 peer-placeholder-shown:translate-y-0 peer-focus:scale-75 peer-focus:-translate-y-6">Mãe</label>
    </div>
  </form>
</template>
