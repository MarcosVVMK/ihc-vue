    ...
    <div class="flex space-x-4 mb-5">
      ...
      <div class="relative z-0 w-1/2 group">
        <select name="sexo" id="sexo"
          ...
          <option value="" disabled selected class="bg-teal-300 dark:bg-gray-900"></option>
          <option value="masculino" class="bg-teal-300 dark:bg-gray-900">Masculino</option>
          <option value="feminino" class="bg-teal-300 dark:bg-gray-900">Feminino</option>
          <option value="outro" class="bg-teal-300 dark:bg-gray-900">Outro</option>
        </select>
        <label for="sexo"
      ...
      <div class="relative z-0 w-1/2 group">
        <select name="raca_cor" id="raca_cor"
          ...
          required autocomplete="off">
          <option value="" disabled selected class="bg-teal-300 dark:bg-gray-900"></option>
          <option value="branca" class="bg-teal-300 dark:bg-gray-900">Branca</option>
          <option value="preta" class="bg-teal-300 darkbg-gray-900">Preta</option>
          <option value="parda" class="bg-teal-300 dark:bg-gray-900">Parda</option>
          <option value="indigena" class="bg-teal-300 dark:bg-gray-900">Indígena</option>
          <option value="outros" class="bg-teal-300 dark:bg-gray-900">Outros</option>
        </select>
        <label for="raca_cor"
